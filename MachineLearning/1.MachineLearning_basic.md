...
```
여러 개의 연산이 들어가 있는 계산 그래프의 경우에는 마지막 연산을 결과로 출력하면 이전의 연산이 모두 이어지는 것을 알 수 있다. 각각의 예제의 계산 그래프는 다음과 같이 시각화 된다. (위 : 한 개의 연산 적용, 아래 : 여러 개의 연산 적용 그래프)
...
[Simple_cal]:https://imgur.com/SZvgWla.png
[Multi_cal]:https://imgur.com/34imEq8.png
