...
## CSS - 개념 이해
HTML 태그를 보조하여 웹 페이지를 꾸미는 역할을 하는 CSS에 대해 살펴봅니다. CSS란 무엇인가에 대해 알아본 후 그 역할에 대해 생각해 봅니다. CSS 기본 구조는 어떻게 이루어졌는지 파악하고 해당 용어에 대해 학습합니다. CSS를 HTML에 포함하는 방법 3가지를 알아본 후 각각의 차이점에 대해 생각해 봅니다.
