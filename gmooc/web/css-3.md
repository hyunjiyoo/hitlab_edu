...
## CSS - 박스 모델
스타일 속성을 적용하려면 먼저 스타일 값으로 입력할 수 있는 CSS 단위부터 알아야 합니다. 스타일 값으로 입력할 수 있는 단위에는 어떤 것이 있는지 살펴봅니다. 박스 모델은 웹 페이지의 레이아웃을 구성할 때 매우 중요한 개념입니다. 박스 모델의 개념을 이해하고 각 속성의 사용법과 차이점을 알아봅니다.
