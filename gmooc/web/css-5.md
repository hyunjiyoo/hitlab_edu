...
## CSS - 레이아웃
웹 페이지 개발에 사용하는 주요 레이아웃 구성 방법을 정리합니다. 먼저, HTML요소의 레벨에 따른 나열방법에 대해 살펴봅니다. 그리고 레이아웃을 정렬할 때 사용하는 속성들의 사용법과 페이지에 요소를 배치하는 방법을 학습합니다. 요소 배치 방법 4가지를 학습한 후 각각의 차이점을 생각해 봅니다.
